...
$(document).ready(function () {
  ...
  function contshow1(){
    window.location.href="https://github.com/Linkusahoo479";
    window.open('https://github.com/Linkusahoo479', '_blank');
  }
  ...
  function contshow3(){
    // window.location.href="https://twitter.com/Ssmr_2654";
    window.open('https://twitter.com/Ssmr_2654', '_blank');
  }
  ...
  function downloadResume(){
    url = "https://drive.google.com/file/d/10Jwx6ZARJ8yaxwcIUWkr7OsabKGJN0VB/view?usp=drive_link";
         window.open(url);
  }
